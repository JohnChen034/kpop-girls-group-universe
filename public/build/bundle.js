...
var app = (function () {
    ...
    // (109:0) {#each Array(36) as _, index}
    function create_each_block_3(ctx) {
    	let button;
    	let t_value = /*groups*/ ctx[9][/*index*/ ctx[25]] + "";
    	let t;
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[19](/*index*/ ctx[25]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "style", button_style_value = "background-color: " + (/*lineVisibility*/ ctx[7][/*index*/ ctx[25]]
    			? /*colorCodes*/ ctx[10][/*index*/ ctx[25]]
    			: '') + "; #E5E7E9 color: " + (/*lineVisibility*/ ctx[7][/*index*/ ctx[25]]
    			? 'white'
    			: 'black') + " border-radius: 50%; /* This will make the button round */ padding: 10px; /* Adjust padding as needed */");

    			add_location(button, file$2, 109, 4, 4145);
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*lineVisibility*/ 128 && button_style_value !== (button_style_value = "background-color: " + (/*lineVisibility*/ ctx[7][/*index*/ ctx[25]]
    			? /*colorCodes*/ ctx[10][/*index*/ ctx[25]]
    			: '') + "; #E5E7E9 color: " + (/*lineVisibility*/ ctx[7][/*index*/ ctx[25]]
    			? 'white'
    			: 'black') + " border-radius: 50%; /* This will make the button round */ padding: 10px; /* Adjust padding as needed */")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(109:0) {#each Array(36) as _, index}",
    		ctx
    	});
    ...
    // (173:8) {#each xScale.ticks() as tick}
    function create_each_block_2(ctx) {
    	let line;
    	let text_1;
    	let t_value = /*tick*/ ctx[26].getFullYear() + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "stroke-opacity", "0.3");
    			attr_dev(line, "x1", /*xScale*/ ctx[11](/*tick*/ ctx[26]));
    			attr_dev(line, "x2", /*xScale*/ ctx[11](/*tick*/ ctx[26]));
    			attr_dev(line, "y1", 0);
    			attr_dev(line, "y2", 6);
    			add_location(line, file$2, 174, 12, 5956);
    			attr_dev(text_1, "fill", "currentColor");
    			attr_dev(text_1, "font-family", "Trebuchet MS");
    			attr_dev(text_1, "text-anchor", "middle");
    			attr_dev(text_1, "x", /*xScale*/ ctx[11](/*tick*/ ctx[26]));
    			attr_dev(text_1, "y", 22);
    			add_location(text_1, file$2, 184, 12, 6243);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(173:8) {#each xScale.ticks() as tick}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line0, "stroke-opacity", "0.1");
    			attr_dev(line0, "x1", 0);
    			attr_dev(line0, "x2", line0_x__value_1 = /*width*/ ctx[1] - /*marginLeft*/ ctx[6]);
    			attr_dev(line0, "y1", /*yScale*/ ctx[12](/*tick*/ ctx[26]));
    			attr_dev(line0, "y2", /*yScale*/ ctx[12](/*tick*/ ctx[26]));
    			add_location(line0, file$2, 198, 16, 6755);
    			attr_dev(line1, "stroke", "currentColor");
    			attr_dev(line1, "stroke-opacity", "0.1");
    			attr_dev(line1, "x1", 0);
    			attr_dev(line1, "x2", -6);
    			attr_dev(line1, "y1", /*yScale*/ ctx[12](/*tick*/ ctx[26]));
    			attr_dev(line1, "y2", /*yScale*/ ctx[12](/*tick*/ ctx[26]));
    			add_location(line1, file$2, 211, 16, 7211);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*width, marginLeft*/ 66 && line0_x__value_1 !== (line0_x__value_1 = /*width*/ ctx[1] - /*marginLeft*/ ctx[6])) {
    ...
    // (193:8) {#each [0, 25, 50, 75, 100] as tick}
    function create_each_block_1(ctx) {
    	let text_1;
    	let t;
    	let if_block = /*tick*/ ctx[26] !== 0 && create_if_block$1(ctx);

    	const block = {
    		c: function create() {
    			if (if_block) if_block.c();
    			text_1 = svg_element("text");
    			t = text$1(/*tick*/ ctx[26]);
    			attr_dev(text_1, "fill", "currentColor");
    			attr_dev(text_1, "text-anchor", "end");
    			attr_dev(text_1, "dominant-baseline", "middle");
    			attr_dev(text_1, "font-family", "Trebuchet MS");
    			attr_dev(text_1, "x", -9);
    			attr_dev(text_1, "y", /*yScale*/ ctx[12](/*tick*/ ctx[26]));
    			add_location(text_1, file$2, 222, 12, 7545);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (/*tick*/ ctx[26] !== 0) if_block.p(ctx, dirty);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(193:8) {#each [0, 25, 50, 75, 100] as tick}",
    		ctx
    	});
    ...
    // (236:4) {#each lines as line, index}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path, "stroke", /*colorCodes*/ ctx[10][/*index*/ ctx[25] % /*colorCodes*/ ctx[10].length]);
    			attr_dev(path, "stroke-width", "3");
    			attr_dev(path, "d", path_d_value = /*lines*/ ctx[13][/*index*/ ctx[25]](/*LineChartData*/ ctx[0]));
    			set_style(path, "opacity", /*lineVisibility*/ ctx[7][/*index*/ ctx[25]] ? 1 : 0);
    			add_location(path, file$2, 236, 8, 7911);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, path, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*LineChartData*/ 1 && path_d_value !== (path_d_value = /*lines*/ ctx[13][/*index*/ ctx[25]](/*LineChartData*/ ctx[0]))) {
    				attr_dev(path, "d", path_d_value);
    			}

    			if (dirty[0] & /*lineVisibility*/ 128) {
    				set_style(path, "opacity", /*lineVisibility*/ ctx[7][/*index*/ ctx[25]] ? 1 : 0);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(236:4) {#each lines as line, index}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let each_value_2 = /*xScale*/ ctx[11].ticks();
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text$1("Popularity of Kpop Girl Groups\n    ");
    			text1 = svg_element("text");
    			t2 = text$1("Month, Year\n    ");
    			...
    			attr_dev(text0, "x", text0_x_value = (/*width*/ ctx[1] - /*marginLeft*/ ctx[6] - /*marginRight*/ ctx[4]) / 2 + /*marginLeft*/ ctx[6]);
    			attr_dev(text0, "y", text0_y_value = /*marginTop*/ ctx[3] / 2);
    			attr_dev(text0, "fill", "currentColor");
    			attr_dev(text0, "font-family", "Trebuchet MS");
    			attr_dev(text0, "font-size", "24px");
    			attr_dev(text0, "text-anchor", "middle");
    			add_location(text0, file$2, 131, 4, 4689);
    			attr_dev(text1, "x", text1_x_value = (/*width*/ ctx[1] - /*marginLeft*/ ctx[6] - /*marginRight*/ ctx[4]) / 2 + /*marginLeft*/ ctx[6]);
    			attr_dev(text1, "y", /*height*/ ctx[2]);
    			attr_dev(text1, "fill", "currentColor");
    			attr_dev(text1, "font-family", "Trebuchet MS");
    			attr_dev(text1, "font-size", "15px");
    			attr_dev(text1, "text-anchor", "middle");
    			add_location(text1, file$2, 143, 4, 5014);
    			attr_dev(text2, "x", text2_x_value = (/*width*/ ctx[1] - /*marginLeft*/ ctx[6] - /*marginRight*/ ctx[4]) / 2 + /*marginLeft*/ ctx[6] - 150);
    			attr_dev(text2, "y", -470);
    			attr_dev(text2, "fill", "currentColor");
    			attr_dev(text2, "font-family", "Trebuchet MS");
    			attr_dev(text2, "font-size", "15px");
    			attr_dev(text2, "text-anchor", "middle");
    			attr_dev(text2, "transform", text2_transform_value = "rotate(-90, " + ((/*width*/ ctx[1] - /*marginLeft*/ ctx[6] - /*marginRight*/ ctx[4]) / 2 + /*marginLeft*/ ctx[6]) + ", " + /*marginTop*/ ctx[3] / 2 + ")");
    			add_location(text2, file$2, 155, 4, 5313);
    			attr_dev(line, "stroke", "currentColor");
    			attr_dev(line, "stroke-width", "2");
    			attr_dev(line, "stroke-opacity", "0.3");
    			attr_dev(line, "x1", line_x__value = /*marginLeft*/ ctx[6] - 6);
    			attr_dev(line, "x2", /*width*/ ctx[1]);
    			add_location(line, file$2, 170, 8, 5773);
    			attr_dev(g0, "transform", g0_transform_value = "translate(0," + (/*height*/ ctx[2] - /*marginBottom*/ ctx[5]) + ")");
    			add_location(g0, file$2, 169, 4, 5712);
    			attr_dev(g1, "transform", g1_transform_value = "translate(" + /*marginLeft*/ ctx[6] + ",0)");
    			add_location(g1, file$2, 191, 4, 6464);
    			attr_dev(svg, "width", /*width*/ ctx[1]);
    			attr_dev(svg, "height", /*height*/ ctx[2]);
    			attr_dev(svg, "viewBox", svg_viewBox_value = "0 0 " + /*width*/ ctx[1] + " " + /*height*/ ctx[2]);
    			set_style(svg, "max-width", `100%`);
    			set_style(svg, "height", `auto`);
    			add_location(svg, file$2, 122, 0, 4527);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*lineVisibility, colorCodes, handleButtonClick, groups*/ 1920) {
    				each_value_3 = Array(36);
    				validate_each_argument(each_value_3);
    				let i;
    			...
    			if (dirty[0] & /*width, marginLeft, marginRight*/ 82 && text0_x_value !== (text0_x_value = (/*width*/ ctx[1] - /*marginLeft*/ ctx[6] - /*marginRight*/ ctx[4]) / 2 + /*marginLeft*/ ctx[6])) {
    				attr_dev(text0, "x", text0_x_value);
    			}

    			if (dirty[0] & /*marginTop*/ 8 && text0_y_value !== (text0_y_value = /*marginTop*/ ctx[3] / 2)) {
    				attr_dev(text0, "y", text0_y_value);
    			}

    			if (dirty[0] & /*width, marginLeft, marginRight*/ 82 && text1_x_value !== (text1_x_value = (/*width*/ ctx[1] - /*marginLeft*/ ctx[6] - /*marginRight*/ ctx[4]) / 2 + /*marginLeft*/ ctx[6])) {
    			...
    			if (dirty[0] & /*width, marginLeft, marginRight*/ 82 && text2_x_value !== (text2_x_value = (/*width*/ ctx[1] - /*marginLeft*/ ctx[6] - /*marginRight*/ ctx[4]) / 2 + /*marginLeft*/ ctx[6] - 150)) {
    				attr_dev(text2, "x", text2_x_value);
    			}

    			if (dirty[0] & /*width, marginLeft, marginRight, marginTop*/ 90 && text2_transform_value !== (text2_transform_value = "rotate(-90, " + ((/*width*/ ctx[1] - /*marginLeft*/ ctx[6] - /*marginRight*/ ctx[4]) / 2 + /*marginLeft*/ ctx[6]) + ", " + /*marginTop*/ ctx[3] / 2 + ")")) {
    				attr_dev(text2, "transform", text2_transform_value);
    			}

    			if (dirty[0] & /*marginLeft*/ 64 && line_x__value !== (line_x__value = /*marginLeft*/ ctx[6] - 6)) {
    			...
    			if (dirty[0] & /*xScale*/ 2048) {
    				each_value_2 = /*xScale*/ ctx[11].ticks();
    				validate_each_argument(each_value_2);
    				let i;
    			...
    			if (dirty[0] & /*height, marginBottom*/ 36 && g0_transform_value !== (g0_transform_value = "translate(0," + (/*height*/ ctx[2] - /*marginBottom*/ ctx[5]) + ")")) {
    				attr_dev(g0, "transform", g0_transform_value);
    			}

    			if (dirty[0] & /*yScale, width, marginLeft*/ 4162) {
    			...
    			if (dirty[0] & /*marginLeft*/ 64 && g1_transform_value !== (g1_transform_value = "translate(" + /*marginLeft*/ ctx[6] + ",0)")) {
    				attr_dev(g1, "transform", g1_transform_value);
    			}

    			if (dirty[0] & /*colorCodes, lines, LineChartData, lineVisibility*/ 9345) {
    				each_value = /*lines*/ ctx[13];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty[0] & /*width, height*/ 6 && svg_viewBox_value !== (svg_viewBox_value = "0 0 " + /*width*/ ctx[1] + " " + /*height*/ ctx[2])) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { LineChartData } = $$props;
    	let { GroupName } = $$props;
    	let { width = 1000 } = $$props;
    	let { height = 400 } = $$props;
    	let { marginTop = 60 } = $$props;
    	let { marginRight = 30 } = $$props;
    	let { marginBottom = 60 } = $$props;
    	let { marginLeft = 60 } = $$props;
    	const startDate = timeParse("%Y-%m")("2010-01");
    	const endDate = timeParse("%Y-%m")("2024-02");
    	...
    	function handleButtonClick(index) {
    		$$invalidate(16, pass_index = index);
    		$$invalidate(15, lastAction = "button");
    	...
    	const xScale = time().domain([startDate, endDate]).range([marginLeft, width - marginRight]);

    	// Create the y (vertical position) scale.
    	const yScale = linear().domain([0, 100]).range([height - marginBottom, marginTop]);

    	// Creating lines
    	let lines = [];

    	for (let i = 0; i < 36; i++) {
    		const line$1 = line().x(d => xScale(new Date(d.Month))).y(d => yScale(d[groups[i]]));
    		lines.push(line$1);
    	}
    	...
    	function LineVisibilityFunction(index) {
    		...
    		if (visibleCount >= 3) {
    			...
    			if (lineVisibility[index]) {
    				$$invalidate(7, lineVisibility[index] = false, lineVisibility);
    			}
    		} else {
    			// If maximum limit is not reached, toggle the visibility of the clicked line
    			$$invalidate(7, lineVisibility[index] = !lineVisibility[index], lineVisibility);
    		}
    	}

    	$$self.$$.on_mount.push(function () {
    		if (LineChartData === undefined && !('LineChartData' in $$props || $$self.$$.bound[$$self.$$.props['LineChartData']])) {
    			console_1$2.warn("<LineChart> was created without expected prop 'LineChartData'");
    		}

    		if (GroupName === undefined && !('GroupName' in $$props || $$self.$$.bound[$$self.$$.props['GroupName']])) {
    			console_1$2.warn("<LineChart> was created without expected prop 'GroupName'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<LineChart> was created with unknown prop '${key}'`);
    	});

    	const click_handler = index => handleButtonClick(index);

    	$$self.$$set = $$props => {
    		if ('LineChartData' in $$props) $$invalidate(0, LineChartData = $$props.LineChartData);
    		if ('GroupName' in $$props) $$invalidate(14, GroupName = $$props.GroupName);
    		...
    		if ('marginBottom' in $$props) $$invalidate(5, marginBottom = $$props.marginBottom);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('marginBottom' in $$props) $$invalidate(5, marginBottom = $$props.marginBottom);
    		if ('marginLeft' in $$props) $$invalidate(6, marginLeft = $$props.marginLeft);
    		if ('lastAction' in $$props) $$invalidate(15, lastAction = $$props.lastAction);
    		if ('pass_index' in $$props) $$invalidate(16, pass_index = $$props.pass_index);
    		if ('groupNameIndex' in $$props) $$invalidate(17, groupNameIndex = $$props.groupNameIndex);
    		if ('lineVisibility' in $$props) $$invalidate(7, lineVisibility = $$props.lineVisibility);
    		if ('groups' in $$props) $$invalidate(9, groups = $$props.groups);
    		if ('lines' in $$props) $$invalidate(13, lines = $$props.lines);
    		if ('normalizedGroups' in $$props) $$invalidate(18, normalizedGroups = $$props.normalizedGroups);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*normalizedGroups, GroupName*/ 278528) {
    			// Reactively update the index based on groupname, ensuring case-insensitive comparison
    			$$invalidate(16, pass_index = normalizedGroups.indexOf(GroupName));
    		}

    		if ($$self.$$.dirty[0] & /*pass_index*/ 65536) {
    			if (pass_index !== -1) {
    				LineVisibilityFunction(pass_index);
    			}
    		}

    		if ($$self.$$.dirty[0] & /*GroupName, normalizedGroups*/ 278528) {
    			$$invalidate(17, groupNameIndex = GroupName
    			? normalizedGroups.indexOf(GroupName.toLowerCase())
    			: -1);
    		}

    		if ($$self.$$.dirty[0] & /*GroupName*/ 16384) {
    			if (GroupName) {
    				$$invalidate(15, lastAction = "GroupName");
    			} // groupNameIndex is already being updated reactively
    		}

    		if ($$self.$$.dirty[0] & /*lastAction, lineVisibility, pass_index, groupNameIndex*/ 229504) {
    			if (lastAction === "button") {
    				console.log(lastAction);
    				$$invalidate(7, lineVisibility = lineVisibility.map((_, i) => i === pass_index));
    			} else if (lastAction === "GroupName") {
    				console.log(lastAction);
    				$$invalidate(7, lineVisibility = lineVisibility.map((_, i) => i === groupNameIndex));
    			}
    		}

    		if ($$self.$$.dirty[0] & /*lineVisibility, pass_index*/ 65664) {
    			$$invalidate(7, lineVisibility = lineVisibility.map((_, i) => i === pass_index));
    		}
    	};

    	$$invalidate(18, normalizedGroups = groups.map(g => g.toLowerCase()));
    ...
    function create_fragment$1(ctx) {
    	...
    	linechart = new LineChart({
    			props: {
    				LineChartData: /*LineChartData*/ ctx[0],
    				GroupName: /*GroupName*/ ctx[1]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(svg, "class", "svelte-1js2r9b");
    			add_location(svg, file$1, 162, 4, 6459);
    			attr_dev(div0, "id", "tooltip");
    			attr_dev(div0, "class", "tooltip svelte-1js2r9b");
    			set_style(div0, "opacity", "0");
    			add_location(div0, file$1, 164, 4, 6487);
    			attr_dev(div1, "id", "details");
    			attr_dev(div1, "class", "details svelte-1js2r9b");
    			add_location(div1, file$1, 166, 4, 6553);
    			add_location(main, file$1, 160, 0, 6447);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*LineChartData*/ 1) linechart_changes.LineChartData = /*LineChartData*/ ctx[0];
    			if (dirty & /*GroupName*/ 2) linechart_changes.GroupName = /*GroupName*/ ctx[1];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const drawChart = () => {
    		...
    		const detailsSection = select("#details");

    		// Create SVG container
    		const svg = select('#chart').attr('viewBox', `0 0 ${svgWidth} ${svgHeight}`).attr('preserveAspectRatio', 'xMidYMid meet');

    		// Scale for the x-axis (debut year)
    		const xScale = linear().domain([2000, 2023]).range([margin.left, svgWidth - margin.right]); // Fixed domain for years 2000 to 2023
    		...
    		generations.forEach(generation => {
    			svg.append('line').attr('x1', xScale(generation.year)).attr('x2', xScale(generation.year)).attr('y1', margin.top).attr('y2', svgHeight - margin.bottom).attr('stroke', '#007bff').attr('stroke-dasharray', '5,5').style('fill', '#333');

    			svg.append('text').attr('x', xScale(generation.year)).attr('y', margin.top - 5).attr('text-anchor', 'middle').text(generation.label); // Position the label slightly above the top of the line
    		...
    		const groupSelection = svg.selectAll('.group').data(groups).enter().append('g').attr('class', 'group').attr('transform', d => `translate(${xScale(d.debut) - imageSize / 2}, ${svgHeight / 2 - imageSize / 2 + d.position * yOffset})`);

    		// Inside drawChart function, where you append images and handle hover events
    		groupSelection.append('image').attr('xlink:href', d => d.url).attr('width', imageSize).attr('height', imageSize).attr('x', -imageSize / 2).attr('y', -imageSize / 2).on('click', (event, d) => {
    			// Update the details section with the specificInfo of the clicked group
    			$$invalidate(1, GroupName = d.name.toLowerCase());
    			...
    			select(this).transition().duration(300).attr('width', enlargedSize).attr('height', enlargedSize).attr('x', -enlargedSize / 2).attr('y', -enlargedSize / 2); // Duration of the enlarge transition
    			// Adjust the x and y to keep the image centered
    			...
    			select(this).transition().duration(300).attr('width', imageSize).attr('height', imageSize).attr('x', -imageSize / 2).attr('y', -imageSize / 2); // Tooltip logic remains unchanged, ensure it's set to show the tooltip without hiding it on mouseout
    			// Duration of the shrink transition
    			// Correctly adjust back the x and y to keep the image centered

    			tooltip.transition().duration(500).style("opacity", 0);
    		});

    		// Draw the x-axis
    		const xAxis = axisBottom(xScale).tickFormat(format("d")).ticks(23);

    		svg.append("g").attr("transform", `translate(0,${svgHeight - margin.bottom})`).call(xAxis).attr("color", "black");
    	};

    	$$self.$$.on_mount.push(function () {
    		if (data === undefined && !('data' in $$props || $$self.$$.bound[$$self.$$.props['data']])) {
    			console_1$1.warn("<Bubble> was created without expected prop 'data'");
    		}

    		if (LineChartData === undefined && !('LineChartData' in $$props || $$self.$$.bound[$$self.$$.props['LineChartData']])) {
    			console_1$1.warn("<Bubble> was created without expected prop 'LineChartData'");
    		}
    	});

    	const writable_props = ['data', 'LineChartData'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Bubble> was created with unknown prop '${key}'`);
    	});
    	...
    	return [LineChartData, GroupName, data];
    }

    class Bubble extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$1, create_fragment$1, safe_not_equal, { data: 2, LineChartData: 0 });
    ...
    function create_if_block(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*LineChartData*/ ctx[1] && create_if_block_1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*LineChartData*/ ctx[1]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*LineChartData*/ 2) {
    ...
    function create_if_block_1(ctx) {
    	...
    	bubble_1 = new Bubble({
    			props: {
    				data: /*data*/ ctx[0],
    				LineChartData: /*LineChartData*/ ctx[1]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*data*/ 1) bubble_1_changes.data = /*data*/ ctx[0];
    			if (dirty & /*LineChartData*/ 2) bubble_1_changes.LineChartData = /*LineChartData*/ ctx[1];
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Kpop Girls Group Universe!";
    			t1 = space();
    			if (if_block) if_block.c();
    			attr_dev(h1, "class", "svelte-u9qvfs");
    			add_location(h1, file, 22, 4, 470);
    			attr_dev(main, "class", "svelte-u9qvfs");
    			add_location(main, file, 21, 0, 459);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(1, LineChartData = await res2.json());
    	...
    	$$self.$capture_state = () => ({ onMount, Bubble, data, LineChartData });

    	$$self.$inject_state = $$props => {
    		if ('data' in $$props) $$invalidate(0, data = $$props.data);
    		if ('LineChartData' in $$props) $$invalidate(1, LineChartData = $$props.LineChartData);
    	};
